<?php
/*
Insere campos na opção de edição avançada dos menus
Credito: https://gist.github.com/kucrut/3804376
*/
...
function mytheme_menu_item_additional_fields( $fields ) {
	$fields['atributo_icone'] = array(
		'name' => 'classe_icone',
		'label' => __('Classe do Icone Font Awesome', 'classe'),
		'container_class' => 'attr_icone',
		'input_type' => 'text',
	);
